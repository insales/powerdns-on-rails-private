...
describe "audits/domain.html.haml" do
  context "and domain audits" do
    ...
    it "should handle no audit entries on the domain" do
      ...
      rendered.should have_tag("em", :text => "No revisions found for the domain")
    end
    ...
    it "should handle audit entries on the domain" do
      ...
      rendered.should have_tag("ul > li > a", :text => "1 create by")
    end
  ...
  context "and resource record audits" do
    ...
    it "should handle no audit entries" do
      ...
      rendered.should have_tag("em", :text => "No revisions found for any resource records of the domain")
    end
    ...
    it "should handle audit entries" do
      ...
      rendered.should have_tag("ul > li > a", :text => "1 create by admin")
    end
